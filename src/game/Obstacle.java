...
public class Obstacle {
     ...
     *
     * @param _x      The x-coordinate of the top left of the obstacle
     * @param _y      The y-coordinate of the top right of the obstacle
     * @param _width  The width of the obstacle
     * @param _height The height of the obstacle
     */
     ...
     *
     * @param _topLeft     The position of the top left of the obstacle
     * @param _bottomLeft  The position of the bottom left of the obstacle
     * @param _bottomRight The position of the bottom right of the obstacle
     * @param _topRight    The position of the top right of the obstacle
     */
